...
HD_PWD='/home/huezzo/Documents/LIESE/SDIO_Zynq_7020/hw/vivado_proj/zybo_sdio/zybo_sdio.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_sdio_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_sdio_bd_wrapper.tcl -notrace
